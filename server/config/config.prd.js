...
var config = {
    ...
    // https://front-present-builder.herokuapp.com/
    frontend: 'https://front-present-builder.herokuapp.com', //'http://page-front.winscorewin.net',
    ObjectID: ObjectID,
    ObjectId: ObjectID,
    email: core.email,
    istab: false,
    ...
    // tempdir: path.join(__dirname, '../../documents'),
    // tempdir: path.join(__dirname+"/documents"),
    // tempdir: path.join(__dirname+"../../../documents"),
    // tempdir: path.join(__dirname+"/documents"),
    ...
    phantomjs: path.join(__dirname, '/phantomjs-2.1.1-windows/bin/phantomjs.exe'),
    ...
    appurl: 'https://backend-present-builder.herokuapp.com'
